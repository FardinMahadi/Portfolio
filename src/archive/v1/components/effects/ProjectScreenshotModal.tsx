...
import type { ProjectScreenshotModalProps } from '@/archive/v1/components/types/shared/effects';
...
import { ImageWithFallback } from '@/archive/v1/components/figma/ImageWithFallback';
