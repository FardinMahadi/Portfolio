...
import type { ViewTransitionWrapperProps } from '@/archive/v1/components/types/shared/effects';

import { useEffect } from 'react';
import { usePathname } from 'next/navigation';

import { supportsViewTransitions, startViewTransition } from '@/archive/v1/lib/transitions';
