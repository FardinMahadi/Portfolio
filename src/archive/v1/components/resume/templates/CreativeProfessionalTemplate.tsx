...
export function CreativeProfessionalTemplate({ data, imageSrc }: ResumeTemplateProps) {
  return (
    <ResumeLayout backgroundColor="#f8fafc">
      <View style={{ marginBottom: 10 }}>
        ...
        <Text style={{ color: '#475569', fontSize: 10 }}>{data.personalInfo.title}</Text>
      </View>

      <View style={styles.grid}>
        <View style={styles.sidebar}>
          <View style={{ alignItems: 'center' }}>
            <ResumeImage src={imageSrc ?? data.personalInfo.image ?? ''} size={80} />
          </View>
          <View>
