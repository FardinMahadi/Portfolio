...
import type { TextareaFieldProps } from '@/archive/v1/components/types/landing/contact';

import { Textarea } from '@/archive/v1/components/ui/textarea';

export function TextareaField({ label, placeholder, value, error, onChange }: TextareaFieldProps) {
  return (
    <div>
      <label
