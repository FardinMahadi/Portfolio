    ...
    <section id="contact" className="py-24" ref={ref}>
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-10">
                ...
                <div className="p-4 space-y-4">
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      <span className="text-code-keyword text-[#ff79c6]">const</span> name =
                    </label>
                    <input
                      type="text"
                      value={name}
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      <span className="text-code-keyword text-[#ff79c6]">const</span> email =
                    </label>
                    <input
                      type="email"
                      value={email}
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      <span className="text-code-keyword text-[#ff79c6]">const</span> message =
                    </label>
                    <textarea
                      value={message}
          ...
          >
            <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm w-full">
