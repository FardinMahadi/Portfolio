    ...
    <div className="bg-card border border-border rounded-lg overflow-hidden font-mono text-sm">
      ...
      <div className="p-4 flex items-center gap-4">
        ...
        <div className="text-base md:text-lg">
          ...
          <span className="text-green-500">'{displayed}<span className="animate-pulse text-primary">|</span>'</span>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">empathy and code.</span>
            </h1>
